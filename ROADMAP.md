...
- [ ] All event types execute:
  - [ ] TEXT and DISPLAY (MESSAGE, TITLE, BOSSBAR)
  - [ ] SOUND
  - [ ] VISUAL EFFECTS (PARTICLE, EFFECT)
  - [ ] TEAM and GROUPS (GROUP_ASSIGN, GROUP_EVENT)
  - [ ] FIREWORKS and SPATIAL PATTERNS (FIREWORK_CIRCLE, FIREWORK_LINE, FIREWORK_FAN, FIREWORK_RANDOM)
  - [ ] WORLD and ENVIRONMENT (WEATHER, TIME)
  - [ ] ENTITY MANAGEMENT (CAPTURE_ENTITIES, RELEASE_ENTITIES)
  - [ ] ENTITY BEHAVIOR (GLOW, ENTITY_EFFECT)
  - [ ] STAGE DIRECTIONS (CROSS_TO, LOOK_AT)
  - [ ] PLAYER MOVEMENT (TELEPORT, HOME)
  - [ ] UTILITY (WAIT, CUE)
