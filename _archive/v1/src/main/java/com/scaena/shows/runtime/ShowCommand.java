...
public final class ShowCommand implements CommandExecutor, TabCompleter {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (args.length == 0) {
            wrap.sendPlain("Usage: /show list | /show play <showId> <player|@a> [--follow|--static] [--private] [--scenes] | /show stop <player|@a> | /show stopall | /show reload");
            return true;
        }
        ...
        switch (sub) {
            ...
            case "play" -> {
                if (args.length < 3) {
                    wrap.sendPlain("Usage: /show play <showId> <player|@a> [--follow|--static] [--private] [--scenes]");
                    return true;
                }
                ...
                for (int i = 3; i < args.length; i++) {
                    ...
                    if ("--scenes".equalsIgnoreCase(args[i])) scenesFlag = true;
                }
                ...
                if (scenesFlag && !(sender.hasPermission(c.adminPermission()))) {
                    wrap.sendPlain("You do not have permission to use --scenes.");
                    return true;
                }
                ...
                showManager.play(wrap, initiator, showId, targets, mode, privateFlag, scenesFlag);
                return true;
            }
    ...
    public List<String> onTabComplete(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (args.length >= 4 && "play".equalsIgnoreCase(args[0])) {
            ...
            if (sender.hasPermission(c.adminPermission())) flags.add("--scenes");
