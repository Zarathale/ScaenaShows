...
public final class ShowManager {
    ...
    public void play(CommandSenderLike sender, Player initiatorOrNull, String showId, Collection<Player> targets, ShowMode mode, boolean privateFlag) {
        ...
        for (Player target : targets) {
            ...
            RunningShow rs = RunningShow.create(this, def, target, effectiveMode, showAudience);
            running.put(tid, rs);
            started++;
        }
